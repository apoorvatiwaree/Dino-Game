...
class Background:
    ...
    def set_texture(self):
        path = os.path.join('images/bg.png')
...
class Dino:
    ...
    def set_texture(self):
        path = os.path.join(f'images/dino{self.texture_num}.png')
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))

    def set_sound(self):
        path = os.path.join('sounds/jump.wav')
...
class Cactus:
    ...
    def set_texture(self):
        path = os.path.join('images/cactus.png')
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))
...
class Score:
    ...
    def set_sound(self):
        path = os.path.join('sounds/point.wav')
        self.sound = pygame.mixer.Sound(path)
...
class Game:
    ...
    def set_sound(self):
        path = os.path.join('sounds/die.wav')
        self.sound = pygame.mixer.Sound(path)
